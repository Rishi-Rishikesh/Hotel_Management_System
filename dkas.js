...
// Enhanced placeholder images with food-themed examples
const placeholderImages = {
  burger: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80',
  pizza: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80',
  pasta: 'https://images.unsplash.com/photo-1555949258-eb67b1ef0ceb?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80',
  salad: 'https://images.unsplash.com/photo-1546793665-c74683f339c1?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80',
  pancakes: 'https://images.unsplash.com/photo-1506084868230-bb9d95c24759?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80',
  tea: 'https://images.unsplash.com/photo-1564890369478-c89ca6d9cde9?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80',
  cola: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80',
};
  ...
  const initialMenuItems = [
    {
      ...
      image: placeholderImages.burger,
      mealType: 'Lunch',
      category: 'Main',
      rating: 4.5,
      calories: 550,
    ...
    },
    {
      ...
      name: 'Garden Salad',
      price: 6.99,
      description: 'Fresh mixed greens with cherry tomatoes and balsamic dressing',
    ...
    },
    {
      ...
      price: 7.49,
      description: 'Stack of three buttermilk pancakes with maple syrup',
      image: placeholderImages.pancakes,
      mealType: 'Breakfast',
      category: 'Main',
      rating: 4.7,
      calories: 480,
    ...
    },
    {
      ...
      name: 'Cola Can',
      price: 1.99,
      description: 'Chilled 12oz can of cola',
      image: placeholderImages.cola,
      mealType: 'Lunch',
      category: 'Can',
      rating: 3.9,
      calories: 140,
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      ...
      >
        <div className="max-w-7xl mx-auto">
          {/* Hero Section with Featured Dishes Carousel */}
          <motion.section
            ...
            className="mb-16"
          >
            <div className="relative bg-gradient-to-r from-orange-500 to-amber-500 rounded-3xl p-8 shadow-2xl overflow-hidden">
              <motion.div
                initial={{ scale: 1 }}
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-white/80 mb-6 max-w-xl">
                  Savor the best dishes crafted with love. Explore our menu and satisfy your cravings today!
                </p>
                <motion.div
                ...
                >
                  {featuredItems.map((item, index) => (
                    <motion.div
                      ...
                      className="bg-white/90 rounded-xl p-4 shadow-lg flex items-center space-x-4"
                ...
                <motion.button
                  ...
                  className="bg-white text-orange-600 px-6 py-3 rounded-full font-semibold flex items-center shadow-md"
                >
          ...
          <motion.section
            ...
            className="mb-10 sticky top-16 z-20 bg-white/95 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-orange-100"
          >
            <div className="flex flex-col md:flex-row gap-6 justify-between items-center">
              <div className="flex flex-col gap-4 w-full md:w-auto">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['All', 'Main', 'Sorties', 'Tea', 'Can'].map((category) => (
                      <motion.button
                        key={category}
            ...
            >
              <div className="flex items-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900">
                  {selectedMealType === 'All' ? 'Our Full Menu' : `${selectedMealType} Menu`}
                </h3>
              </div>
